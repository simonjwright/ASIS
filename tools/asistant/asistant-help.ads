...
package ASIStant.Help is

------------------------------------------------------------------------------
--  ASIStant Help System
------------------------------------------------------------------------------

   procedure Help (NP : Node_Position);
   --  Help system: provides
   --   general help
   --   help on ASIStant commands
   --   help on ASIS queries

   procedure ASISHelp;
   --  ASIS and ASIStant tech info

   procedure Display_Kind_Help (K : Flat_Element_Kinds);
   --  Displays list of applicable queries for a given extended Element kind
