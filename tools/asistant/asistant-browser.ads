...
package ASIStant.Browser is

------------------------------------------------------------------------------
--  Browser capability for ASIStant
------------------------------------------------------------------------------

   function Browse (E : Asis.Element) return Asis.Element;
   function Browse (C : Asis.Compilation_Unit) return Asis.Element;
   --  Gateways to the Browser capability
