...
package ASIStant.Browser.Iterator is

   function Next     (E : Asis.Element) return Asis.Element;

   function Previous (E : Asis.Element) return Asis.Element;

   function Up       (E : Asis.Element) return Asis.Element;

   function Down     (E : Asis.Element) return Asis.Element;
