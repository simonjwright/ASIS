...
package ASIStant.Batch_IO is

------------------------------------------------------------------------------
--  Logs and scripts interface
------------------------------------------------------------------------------

   procedure Script_IO (NP : Node_Position);
   --  Open script at the pos. N of syntax tree

   procedure Pause_Script;
   --  Pause current script

   procedure Log_IO (NP : Node_Position);
   --  Open log at the pos. N of syntax tree

   procedure Get_Next_Cmd;
   --  Read next command from the script or from stdin
