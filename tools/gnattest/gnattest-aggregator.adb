...
--                           GNATTEST COMPONENTS                            --
--                                                                          --
--                  G N A T T E S T  . A G G R E G A T O R                  --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body GNATtest.Aggregator is
   ...
   --  The number of test drivers started and in umknown state.
   ...
   begin
      if Cur = No_Element then
         Report_Err ("no test driver " & S & " in source table");
         raise Fatal_Error;
      else
   ...
   begin
      ...
      if TD_Table.Is_Empty then
         Report_Err ("nothing to process in " & Arg_File_Name.all);
      end if;
      ...
      then
         Report_Err ("no test drivers terminated succesfully");
         raise Fatal_Error;
      end if;
