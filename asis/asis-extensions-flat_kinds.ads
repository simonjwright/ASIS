...
package Asis.Extensions.Flat_Kinds is
   ...
   subtype Flat_Defining_Simple_Name_Kinds is Flat_Defining_Name_Kinds
      range A_Defining_Identifier .. A_Defining_Not_Operator;

   subtype Flat_Usage_Name_Kinds is Flat_Element_Kinds
      range An_Identifier .. An_Enumeration_Literal;
   ...
   --  The following two subtypes are for attributes that can have an
   --  expression, as in T'First(2), and those that cannot.

   subtype Flat_Attr_Ref_With_Exp_Kinds is
     Flat_Attribute_Reference_Kinds with
       Predicate => Flat_Attr_Ref_With_Exp_Kinds in
         A_First_Attribute                   |
         A_Last_Attribute                    |
         A_Length_Attribute                  |
         A_Range_Attribute                   |
   ...
   subtype Flat_Attr_Ref_Without_Exp_Kinds is
     Flat_Attribute_Reference_Kinds with
       Predicate => Flat_Attr_Ref_Without_Exp_Kinds not in
   ...
   subtype Flat_List_Kinds is Flat_Element_Kinds'Base
     range An_Element_List .. A_Variant_List;

   subtype Flat_Abstract_Classes is Flat_Element_Kinds'Base
     range An_Element_Class .. A_Statement_Class;

   subtype Flat_Declarative_Item_Kinds is Flat_Element_Kinds with
     Predicate => Flat_Declarative_Item_Kinds in
       Flat_Declaration_Kinds | Flat_Pragma_Kinds | Flat_Clause_Kinds;

   subtype Flat_Name_Kinds is Flat_Element_Kinds with
     Predicate => Flat_Name_Kinds in
       An_Identifier | A_Selected_Component;

   subtype Flat_Range_Constraint_Kinds is Flat_Element_Kinds with
     Predicate => Flat_Range_Constraint_Kinds in
       A_Range_Attribute_Reference | A_Simple_Expression_Range;

   subtype Flat_Record_Component_Kinds is Flat_Element_Kinds with
     Predicate => Flat_Record_Component_Kinds in
       Flat_Pragma_Kinds |
   ...
   function Is_Generic (Declaration : Asis.Declaration) return Boolean;
   --  True if Declaration is the declaration or body of a generic unit
