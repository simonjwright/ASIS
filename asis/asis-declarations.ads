...
--  for analyzing Ada 2005 code, because it does not make sense for arguments
--  that contain anonymous access definitions. We need a proper warning note
--  in the ASIS Standard. Applications should use Object_Declaration_View to
--  decompose all kinds of object declarations

--  --|D2005 end
--  --|A2005 end

--  Appropriate Declaration_Kinds (only in case if the argument does NOT
--  contain an anonymous access definition!):
--       A_Discriminant_Specification
--       A_Parameter_Specification
--       A_Formal_Object_Declaration
--       An_Object_Renaming_Declaration
...
--  Returns False for any unexpected Element.
--
--  --|AN Application Note (GNAT-specific):
--  --|AN
--  --|AN Always returns False for any Element for that
--  --|AN Asis.Text.Is_Text_Available is False
--
--  Expected Declaration_Kinds:
...
--       A_Procedure_Body_Declaration
--       A_Null_Procedure_Declaration  (treated as body, Ada 2012)
...
--
--  Returns An_Aspect_Specification if the Declaration has an Import aspect
--  specification.
--
...
--                                    Nil_Element)
--  --|D2012 start
--       An_Expression_Function_Declaration (in case if it acts as declaration,
--                                    otherwise the result should be
--                                    Nil_Element)
--  --|D2012 end
