...
--  --|A2015 end
   ...
   function Record_Aggregate_Beginning
     (E    : Asis.Element)
      return Source_Ptr;
   --  Is needed because of a special treatment of a SPARK-specific pragma
   --  Depends. The following code:
   --
   --     pragma Depends (A => + B);
   --
   --  Is treated as if the pragma has a record aggregate as an argument, and
   --  there is no pragma_argument_identifier.
...
--      A_Formal_Protected_Interface
      ...
      A_Box_Expression => Box_Expression_Beginning'Access,
      ...
      A_Record_Aggregate => Record_Aggregate_Beginning'Access,
