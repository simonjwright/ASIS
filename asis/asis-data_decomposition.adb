      ...
      when Ex : others =>
         Report_ASIS_Bug
           (Query_Name    => Package_Name &
                             "Array_Components (from Array_Component)",
            Ex            => Ex,
            Arg_Element   => Component.Parent_Array_Type,
            Arg_Element_2 => Component.Parent_Component_Name);
      ...
      when Ex : others =>
         Report_ASIS_Bug
           (Query_Name    => Package_Name &
                            "Array_Components (from Record_Component)",
            Ex            => Ex,
            Arg_Element   => Component.Parent_Record_Type,
            Arg_Element_2 => Component.Component_Name);
   end Array_Components;
