...
package body Asis.Text is
   ...
   is
      ...
      F_Name : constant File_Name_Type    := File_Name (SFI);
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            --  of the physical line that precedes the element
   ...
   function Element_Span (Element : Asis.Element) return Asis.Text.Span is
      ...
      --  Check that we haven't gone past the end of a source file

      procedure Validate_Result is
         SFI : constant Source_File_Index :=
           Get_Source_File_Index (Span_Start);
      begin
         pragma Assert (Span_End in Source_First (SFI) .. Source_Last (SFI));
         pragma Assert (SFI = Get_Source_File_Index (Span_End));
      end Validate_Result;

   --  Start of processing for Element_Span
   ...
   begin
      return Result : constant Boolean :=
        (Right.Last_Line < Right.First_Line) or else
